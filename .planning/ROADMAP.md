...
**Plans**: 2 plans
Plans:
- [ ] 31-01-PLAN.md -- Settings restructure (5 grouped sections, SF Symbol icons, RunDefaultsView sub-page, dynamic version)
...
| 31. Settings + Skeleton States | v1.6 | 0/2 | Not started | - |
