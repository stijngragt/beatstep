...
- [ ] 02-03-PLAN.md -- Gap closure: Cloudflare Worker proxy for GetSongBPM, rewire scan to use GetSongBPM instead of Spotify audio-features
...
| 2. BPM Data Pipeline | 2/3 | Gap closure | - |
