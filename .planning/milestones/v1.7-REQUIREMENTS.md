# Requirements Archive: v1.7 Beat Perfect
...
- [x] **PLAY-01**: Mini player docks above the tab bar without overlapping navigation
- [x] **PLAY-02**: User can collapse the player to a thin drag handle via swipe-down or tap
- [x] **PLAY-03**: User can expand the collapsed player via swipe-up or tap on handle
- [x] **PLAY-04**: Collapsed player shows minimal indicator (handle) that doesn't obstruct tab navigation
...
| PLAY-01 | Phase 34 | Complete |
| PLAY-02 | Phase 35 | Complete |
| PLAY-03 | Phase 35 | Complete |
| PLAY-04 | Phase 35 | Complete |
